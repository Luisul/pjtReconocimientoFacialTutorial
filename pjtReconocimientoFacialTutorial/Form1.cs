...
namespace pjtReconocimientoFacialTutorial
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            face = new HaarCascade(@"C:\ProyectosTest\ReconocimientoFacial02\haarcascade_frontalface_default.xml");
            try
            {
                clsDA.Consultar(d);
        ...
        private void FrameGrabar(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    t = t + 1;
                    result = currentFrame.Copy(R.rect).Convert<Gray, byte>().Resize(100, 100, INTER.CV_INTER_AREA);
